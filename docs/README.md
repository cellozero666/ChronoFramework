...
2. [`protocols/`](protocols/README.md) — normative process contracts, read in numeric order.
3. [`architecture/REFERENCE-ARCHITECTURE.md`](architecture/REFERENCE-ARCHITECTURE.md) — approved technical architecture and boundaries.
4. [`implementation/IMPLEMENTATION-PLAN.md`](implementation/IMPLEMENTATION-PLAN.md) — ordered path from specifications to final v1.
5. [`history/PROTOCOL-AUTHORING-BRIEF.md`](history/PROTOCOL-AUTHORING-BRIEF.md) — non-normative provenance only.
