...
export const ErrorCode = {
  ...
  PROJECTION_FAILED: "PROJECTION_FAILED" as const,
  ...
  UPGRADE_REQUIRED: "UPGRADE_REQUIRED" as const,
  NOT_INTERACTIVE: "NOT_INTERACTIVE" as const,
  PROJECT_EXISTS: "PROJECT_EXISTS" as const,
